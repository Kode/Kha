...
extern "C" void hl_kore_graphics_set_texture_parameters(vbyte *unit, int uAddressing, int vAddressing, int minificationFilter, int magnificationFilter,
                                                        int mipmapFilter) {
...
extern "C" void hl_kore_graphics_set_texture3d_parameters(vbyte *unit, int uAddressing, int vAddressing, int wAddressing, int minificationFilter,
...
extern "C" void hl_kore_graphics_set_matrix(vbyte *location, float _00, float _10, float _20, float _30, float _01, float _11, float _21, float _31, float _02,
...
extern "C" void hl_kore_graphics_set_matrix3(vbyte *location, float _00, float _10, float _20, float _01, float _11, float _21, float _02, float _12,
                                             float _22) {
	Kore::Graphics4::ConstantLocation *loc = (Kore::Graphics4::ConstantLocation *)location;
	Kore::mat3 value;
	value.Set(0, 0, _00);
