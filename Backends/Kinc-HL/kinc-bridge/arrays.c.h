...
vbyte *hl_kore_bytebuffer_alloc(int elements) {
	char *data = (char *)malloc(elements * sizeof(char));
	return (vbyte *)data;
}

void hl_kore_bytebuffer_free(vbyte *bytearray) {
	free(bytearray);
}

// Get

int8_t hl_kore_bytearray_getint8(vbyte *bytearray, int byteoffset) {
	return *((int8_t *)&(bytearray[byteoffset]));
}

uint8_t hl_kore_bytearray_getuint8(vbyte *bytearray, int byteoffset) {
	return *((uint8_t *)&(bytearray[byteoffset]));
}

int16_t hl_kore_bytearray_getint16(vbyte *bytearray, int byteoffset) {
	return *((int16_t *)&bytearray[byteoffset]);
}

uint16_t hl_kore_bytearray_getuint16(vbyte *bytearray, int byteoffset) {
	return *((uint16_t *)&bytearray[byteoffset]);
}

int32_t hl_kore_bytearray_getint32(vbyte *bytearray, int byteoffset) {
	return *((int32_t *)&bytearray[byteoffset]);
}

uint32_t hl_kore_bytearray_getuint32(vbyte *bytearray, int byteoffset) {
	return *((uint32_t *)&bytearray[byteoffset]);
}

float hl_kore_bytearray_getfloat32(vbyte *bytearray, int byteoffset) {
	return *((float *)&bytearray[byteoffset]);
}

double hl_kore_bytearray_getfloat64(vbyte *bytearray, int byteoffset) {
	return *((double *)&bytearray[byteoffset]);
}

// Set

void hl_kore_bytearray_setint8(vbyte *bytearray, int byteoffset, int8_t value) {
	*((int8_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setuint8(vbyte *bytearray, int byteoffset, uint8_t value) {
	*((uint8_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setint16(vbyte *bytearray, int byteoffset, int16_t value) {
	*((int16_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setuint16(vbyte *bytearray, int byteoffset, uint16_t value) {
	*((uint16_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setint32(vbyte *bytearray, int byteoffset, int32_t value) {
	*((int32_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setuint32(vbyte *bytearray, int byteoffset, uint32_t value) {
	*((uint32_t *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setfloat32(vbyte *bytearray, int byteoffset, float value) {
	*((float *)&bytearray[byteoffset]) = value;
}

void hl_kore_bytearray_setfloat64(vbyte *bytearray, int byteoffset, double value) {
	*((double *)&bytearray[byteoffset]) = value;
}

// Get (little endian on big endian system)

int16_t hl_kore_bytearray_getint16_le(vbyte *bytearray, int byteoffset) {
	return (int16_t)(bytearray[byteoffset] << 0 | bytearray[byteoffset + 1] << 8);
}

uint16_t hl_kore_bytearray_getuint16_le(vbyte *bytearray, int byteoffset) {
	return (uint16_t)(bytearray[byteoffset] << 0 | bytearray[byteoffset + 1] << 8);
}

int32_t hl_kore_bytearray_getint32_le(vbyte *bytearray, int byteoffset) {
	return (int32_t)(bytearray[byteoffset] << 0 | bytearray[byteoffset + 1] << 8 | bytearray[byteoffset + 2] << 16 | bytearray[byteoffset + 3] << 24);
}

uint32_t hl_kore_bytearray_getuint32_le(vbyte *bytearray, int byteoffset) {
	return (uint32_t)(bytearray[byteoffset] << 0 | bytearray[byteoffset + 1] << 8 | bytearray[byteoffset + 2] << 16 | bytearray[byteoffset + 3] << 24);
}

float hl_kore_bytearray_getfloat32_le(vbyte *bytearray, int byteoffset) {
	int32_t v = (bytearray[byteoffset] << 0 | bytearray[byteoffset + 1] << 8 | bytearray[byteoffset + 2] << 16 | bytearray[byteoffset + 3] << 24);
	return *(float *)&v;
}

double hl_kore_bytearray_getfloat64_le(vbyte *bytearray, int byteoffset) {
...
void hl_kore_bytearray_setint16_le(vbyte *bytearray, int byteoffset, int16_t value) {
	int8_t *data = (int8_t *)&value;
	int16_t le_value = data[0] << 8 | data[1] << 0;
	*((int16_t *)&bytearray[byteoffset]) = le_value;
}

void hl_kore_bytearray_setuint16_le(vbyte *bytearray, int byteoffset, uint16_t value) {
	int8_t *data = (int8_t *)&value;
	uint16_t le_value = data[0] << 8 | data[1] << 0;
	*((uint16_t *)&bytearray[byteoffset]) = le_value;
}

void hl_kore_bytearray_setint32_le(vbyte *bytearray, int byteoffset, int32_t value) {
	int8_t *data = (int8_t *)&value;
	int32_t le_value = data[0] << 24 | data[1] << 16 | data[2] << 8 | data[3] << 0;
	*((int32_t *)&bytearray[byteoffset]) = le_value;
}

void hl_kore_bytearray_setuint32_le(vbyte *bytearray, int byteoffset, uint32_t value) {
	int8_t *data = (int8_t *)&value;
	uint32_t le_value = data[0] << 24 | data[1] << 16 | data[2] << 8 | data[3] << 0;
	*((uint32_t *)&bytearray[byteoffset]) = le_value;
}

void hl_kore_bytearray_setfloat32_le(vbyte *bytearray, int byteoffset, float value) {
	int8_t *data = (int8_t *)&value;
	int32_t le_value = (data[0] << 24 | data[1] << 16 | data[2] << 8 | data[3] << 0);
	*((float *)&bytearray[byteoffset]) = *(float *)&le_value;
}

void hl_kore_bytearray_setfloat64_le(vbyte *bytearray, int byteoffset, double value) {
	int8_t *data = (int8_t *)&value;
...
void hl_kore_bytearray_setint16_be(vbyte *bytearray, int byteoffset, int16_t value) {
	int8_t *data = (int8_t *)&value;
	int16_t be_value = data[1] << 8 | data[0] << 0;
	*((int16_t *)&bytearray[byteoffset]) = be_value;
}

void hl_kore_bytearray_setuint16_be(vbyte *bytearray, int byteoffset, uint16_t value) {
	int8_t *data = (int8_t *)&value;
	uint16_t be_value = data[1] << 8 | data[0] << 0;
	*((uint16_t *)&bytearray[byteoffset]) = be_value;
}

void hl_kore_bytearray_setint32_be(vbyte *bytearray, int byteoffset, int32_t value) {
	int8_t *data = (int8_t *)&value;
	int32_t be_value = data[3] << 24 | data[2] << 16 | data[1] << 8 | data[0] << 0;
	*((int32_t *)&bytearray[byteoffset]) = be_value;
}

void hl_kore_bytearray_setuint32_be(vbyte *bytearray, int byteoffset, uint32_t value) {
	int8_t *data = (int8_t *)&value;
	uint32_t be_value = data[3] << 24 | data[2] << 16 | data[1] << 8 | data[0] << 0;
	*((uint32_t *)&bytearray[byteoffset]) = be_value;
}

void hl_kore_bytearray_setfloat32_be(vbyte *bytearray, int byteoffset, float value) {
	int8_t *data = (int8_t *)&value;
	int32_t be_value = (data[3] << 24 | data[2] << 16 | data[1] << 8 | data[0] << 0);
	*((float *)&bytearray[byteoffset]) = *(float *)&be_value;
}

void hl_kore_bytearray_setfloat64_be(vbyte *bytearray, int byteoffset, double value) {
	int8_t *data = (int8_t *)&value;
