...
class TessellationEvaluationShader {
	...
	@:hlNative("std", "kinc_create_tessevalshader") static function kore_create_tessevalshader(data: hl.Bytes, length: Int): Pointer {
		return null;
	}

	@:hlNative("std", "kinc_tessevalshader_from_source") static function kore_tessevalshader_from_source(source: hl.Bytes): Pointer {
		return null;
	}
}
