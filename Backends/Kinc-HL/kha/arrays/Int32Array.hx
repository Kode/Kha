...
abstract Int32Array(Int32ArrayPrivate) {
	...
	public inline function new(elements: Int = 0) {
		...
		if (elements > 0) this.self = kore_int32array_alloc(elements);
	}
	...
	@:hlNative("std", "kore_int32array_alloc") static function kore_int32array_alloc(elements: Int): Pointer { return null; }
	...
	@:hlNative("std", "kore_int32array_get") static function kore_int32array_get(u16array: Pointer, index: Int): Int { return 0; }
}
