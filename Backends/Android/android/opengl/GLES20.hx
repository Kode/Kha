...
extern class GLES20 {
	...
	public static function glTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int,
		pixels: Buffer): Void;
	...
	public static function glTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int,
		pixels: Buffer): Void;
	...
	public static function glGetActiveUniform(program: Int, index: Int, bufsize: Int, length: NativeArray<Int>, lengthOffset: Int, size: NativeArray<Int>,
		sizeOffset: Int, type: NativeArray<Int>, typeOffset: Int, name: NativeArray<Int8>, nameOffset: Int): Void;
}
