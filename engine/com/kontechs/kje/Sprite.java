...
public class Sprite {
	...
	public void render(Painter painter) {
		if (image != null) {
			painter.drawImage(image, animation.get() * width % image.getWidth(), Math.floor(animation.get() * width / image.getWidth()) * height, width, height, x - collider.x, y - collider.y, width, height);
